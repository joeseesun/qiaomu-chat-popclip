...
// 获取扩写提示词
var prompt = customPrompt || "请将以下文本进行扩写，保持原意的同时增加细节和深度，使内容更加丰富和完整：\n\n";
...
print("乔木AI：准备扩写文本，原文长度：" + popclip.input.text.length);
...
popclip.showText("正在使用 " + modelName + " 扩写中...");
...
print("乔木AI：扩写完成，新文本长度：" + assistantMessage.content.length);
